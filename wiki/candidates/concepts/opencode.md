...
status: candidate
confidence: 0.65
created_at: '2026-05-11T08:45:09.823Z'
updated_at: '2026-05-11T08:45:09.823Z'
compiled_from:
  - >-
    opencode-local-config-contains-live-api-tokens-use-opencode-json-example-as-temp-fe834141
managed_by: system
...
Frequently referenced concept in opencode local config — contains live API tokens; use opencode.json.example as template.
